...
## Incase user doesn't know about the game
...
## The complete game of Rock-Paper-Scissors-Lizard-Spock
def rpsls():
    ...
    while True:
        ...
        comp_move = random.randint(0, 4) # Computer randomly selects a move
        print()
        time.sleep(2)
        ...
        if winner == player_move:
            ...
            print("TIE GAME")       
        print()
        time.sleep(2) # Wait for 2 seconds before a new game opens
        clear()
...
if __name__ == '__main__':
    ...
    # Win-lose matrix for Rock-Paper-Scissors-Lizard-Spock
